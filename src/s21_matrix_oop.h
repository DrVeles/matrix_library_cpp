...
public:
    ...
    */
     ...
     * @exception The number of columns of the first matrix is not equal to the number of rows of the second matrix.
    */
    ...
    */
    ...
    /**
     * @brief Calculates the algebraic addition matrix of the current one and returns it.	
